...
const options2 = [{ option: '1 a 9' }, { option: '10 a 19' }, { option: '20 a 29' }, { option: '30 a 49' }, { option: '50+' }]

const options3 = [{ option: '1 a 2' }, { option: '3 a 4' }, { option: '5 a 6' }, { option: '7 a 8' }, { option: '9 a 10' }]

const options4 = [{ option: '10-' }, { option: '11 a 15' }, { option: '16 a 20' }, { option: '21 a 25' }, { option: '25+' }]
...
const dataPoll = [
  {
    ...
    questions: [
      ...
      {
        idQuestion: '02',
        question: 'Calidad del producto (certificación, satisfacción del cliente)',
        options: options,
      },
      {
        idQuestion: '03',
      ...
      {
        idQuestion: '15',
        question: 'Estructura administrativa acorde a la estrategia de la empresa',
        options: options,
      },
      {
        idQuestion: '16',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        idQuestion: '24',
        question: 'Falta de plan estratégico (metas, escenarios, planes de contingencia)',
        options: options,
      },
      {
        idQuestion: '25',
        question: 'Diferenciación en el producto, precio, promoción y distribución según mercados',
        options: options,
      },
      {
        idQuestion: '26',
      ...
      {
        idQuestion: '30',
        question: 'Compromiso de la gerencia con el proceso (dedicación de tiempo)',
        options: options,
      },
      {
        idQuestion: '31',
      ...
      {
        idQuestion: '46',
        question: 'Crecer porque el mercado interno es pequeño/descisión de expansión de la empresa',
        options: options,
      },
      {
        idQuestion: '47',
      ...
      {
        idQuestion: '54',
        question: 'Oportunidades identificadas en los acuerdos externos y comerciales',
        options: options,
      },
      {
        idQuestion: '55',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        idQuestion: '06',
        question: 'Son más efectiva a través de contactos en el mercado que de análisis de mercados',
        options: options,
      },
      {
        idQuestion: '07',
      ...
      {
        idQuestion: '09',
        question: 'Los programas de asistencia gubernamentales son imprescindibles para mejorar el desempeño exportador',
        options: options,
      },
      {
        idQuestion: '10',
  ...
  },
  {
    ...
    module: 'Factores de competitividad de la empresa',
    spanTitle: '',
    information: "Las primeras 4 preguntas son de >> si o no << (Siendo la primer 'SI' y la segunda 'NO')",
    questions: [
      {
        idQuestion: '01',
      ...
      {
        idQuestion: '02',
        question: '¿Aproximadamente cuántos productos/servicios desarrolla al año?',
        options: [{ option: '100 a 299' }, { option: '300 a 499' }, { option: '500 a 699' }, { option: '700 a 899' }, { option: '900+' }],
      },
      {
        idQuestion: '02',
        question: '¿Ha realizado estudios para determinar el nivel de satisfacción de los clientes?',
        options: options1,
      },
      {
        idQuestion: '06',
        question: '¿Cuál es el % de inversión que la empresa destina a investigación y desarrollo?',
        options: options2,
      },
      {
        idQuestion: '03',
  ...
  },
  {
    ...
    spanTitle: '',
    information: 'Distribución de las ventas por líneas de productos y servicios',
    questions: [
      {
        idQuestion: '01',
      ...
      },
      {
        ...
        options: [{ option: '100-' }, { option: '101 a 150' }, { option: '151 a 200' }, { option: '201 a 250' }, { option: '250+' }],
      },
      {
        idQuestion: '04',
        question: 'Participación aproximada en las ventas de los tres clientes principales',
        options: [{ option: '2-' }, { option: '2 a 5' }, { option: '6 a 8' }, { option: '9 a 11' }, { option: '11+' }],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        options: [{ option: 'Ninguna' }, { option: 'Casi Ninguna' }, { option: 'Ocasional' }, { option: 'Regular' }, { option: 'Siempre' }],
      },
      {
        idQuestion: '02',
        question: '¿Qué % de (ventas externas / ventas totales) proyecta para el siguiente año',
        options: options4,
      },
      {
        idQuestion: '03',
    ...
    questions: [
      {
        ...
        options: [{ option: '1000' }, { option: '1500' }, { option: '2000' }, { option: '3000' }, { option: '3000+' }],
      },
      {
        idQuestion: '02',
        question: 'Número de empleados',
        options: [{ option: '1 a 9' }, { option: '10 a 49' }, { option: '50 a 249' }, { option: '250 a 500' }, { option: '500+' }],
      },
      {
        idQuestion: '03',
      ...
      },
      {
        ...
        options: [{ option: '1 a 9' }, { option: '10 a 29' }, { option: '30 a 59' }, { option: '60 a 89' }, { option: '90+' }],
      },
      {
        idQuestion: '05',
    ...
    questions: [
      {
        ...
        options: [{ option: '25 a 32' }, { option: '33 a 40' }, { option: '41 a 48' }, { option: '49 a 55' }, { option: '55+' }],
      },
      {
        idQuestion: '02',
        question: 'Años de estudio totales',
        options: [{ option: '11-' }, { option: '11 a 16' }, { option: '17 a 24' }, { option: '25 a 30' }, { option: '31+' }],
      },
      {
        idQuestion: '03',
        question: 'Habilidades en lenguas extranjeras',
        options: [{ option: 'Bajo' }, { option: 'Medio Bajo' }, { option: 'Medio' }, { option: 'Medio Alto' }, { option: 'Alto' }],
      },
    ],
  },
]
